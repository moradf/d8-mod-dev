...
class ReportController extends ControllerBase {
  ...
  protected function load() {
    ...
    // Join the users table, to get the creator's username.
    ...
    // Select specific fields for our output.
  ...
  public function report() {
    $content = [];
    $content['messages'] = [
      '#markup' => $this->t('Below is the list of all Event RSVPs 
        including username, email address and the name of the event they will 
        be attending'),
    ];
    $headers = [
      t('Name'),
